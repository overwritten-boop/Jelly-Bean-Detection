...
net = jetson.inference.imageNet("--network=~/jetson-inference/python/training/classification/models/beans/resnet18.onnx", argv = ["--model=beansnet18.onnx", "--labels=labels.txt"])
