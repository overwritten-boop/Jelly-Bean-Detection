...
net = jetson.inference.imageNet(argv = ["--network=~/jetson-inference/python/training/classification/models/beans/resnet18.onnx", "--model=beansnet18.onnx", "--labels=labels.txt"])
